...
// Page in complete because MR Affan said me to drop this page.
...
const OurServices = () => {
  return (
    <div className='w-full flex flex-col'>
      ...
      {/* Section 2 */}
      <div className='flex flex-col lg:w-[90%] lg:mx-auto lg:my-10 '>
        <h3 className='mb-2 text-[7vw] lg:text-[1.8vw] lg:leading-7 font-[600] capitalize tracking-[0.75px] text-[var(--dark-golden-color)]'>Industries we drive forward</h3>
        <p className='text-[4.3vw] text-[var(--dark-black-color)] lg:text-[1.1vw]'>We propel diverse industries forward with our innovative solutions and expert insights. Our customized approach guarantees that every sector gains from our holistic services and targeted strategies.</p>
