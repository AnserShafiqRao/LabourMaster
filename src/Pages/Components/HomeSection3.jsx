...
const VideoSection = () => {
  return (
    ...
    <div className='video-background-container h-[100%] hideOnMobile mt-8 rounded-3xl'>
        <video autoPlay muted loop className='video-background absolute hideOnMobile'>
          <source src={Video1} type='video/mp4' />
          Your browser does not support the video tag.
        </video>

        <div className='home-section3 bg-[#00000000] lg:bg-[#0000007b] flex flex-col min-h-auto items-center justify-end lg:w-full lg:min-h-[80vh] mx-auto shadow-md'>
          ...
          <div className='flex flex-col lg:flex-row w-[90%]'>
            ...
            <div className='flex flex-col w-full py-2 lg:w-[25%] lg:px-4 lg:min-h-[30vh]'>
              <h3 className='text-[5vw] text-[var(--dark-black-color)] lg:text-[var(--white-color)] capitalize tracking-normal font-[600] lg:text-[1.7vw] '>Tailored Recruitment<br className='hideOnMobile'/> Solutions</h3>
            ...
            <div className='flex flex-col w-full py-2  lg:w-[25%] lg:px-4 lg:min-h-[30vh]'>
              <h3 className='text-[5vw] text-[var(--dark-black-color)] lg:text-[var(--white-color)] capitalize tracking-normal font-[600] lg:text-[1.7vw] '>Recruitment and <br className='hideOnMobile'/>Screening</h3>
            ...
            <div className='flex flex-col w-full py-2 lg:w-[25%] lg:px-4 lg:min-h-[30vh]'>
              <h3 className='text-[5vw] text-[var(--dark-black-color)] lg:text-[var(--white-color)] capitalize tracking-normal font-[600] lg:text-[1.7vw] '>Effective Talent <br className='hideOnMobile'/>Placement</h3>
            ...
            <div className='flex flex-col w-full py-2 lg:w-[25%] lg:px-4 lg:min-h-[30vh]'>
              <h3 className='text-[5vw] text-[var(--dark-black-color)] lg:text-[var(--white-color)] capitalize tracking-normal font-[600] lg:text-[1.7vw] '>Workplace Readiness <br className='hideOnMobile'/>Training</h3>
      ...
      <div className='home-section-3-mobile hideOnDesktop rounded-3xl'>
        <video autoPlay muted loop className='h-[45vh] relative video-background shadow-lg'>
          <source src={Video1_Mobile} type='video/mp4' />
          Your browser does not support the video tag.
        </video>

        <div className='home-section3 flex flex-col min-h-auto items-start justify-end mx-0'>
          
          <h2 className='text-[8vw] mb-1 font-[700] capitalize tracking-wide text-black lg:text-[var(--dark-golden-color)] '>What We Deliver?</h2>
