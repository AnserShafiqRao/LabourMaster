...
const CareerRoles = () => {
  return (
    <div className='flex flex-col justify-start items-start my-8 lg:mb-10 lg:items-start w-full lg:min-h-[80vh]'>
        <h2 className='text-[7vw] lg:text-[2.4vw] font-[700] tracking-normal capitalize'>Virtual Assistant Roles for Marketing Agencies</h2>
        ...
        <div className='grid center grid-cols-1 w-full lg:gap-[5%] lg:grid-cols-[30%_30%_30%]'>
          <div className='flex flex-col my-4 lg:my-1 mx-4'>
            ...
            <div className='mx-1'>
              ...
              <Link to={'/about-us/'}><button className='flex flex-row items-center bg-stone-800 mt-6 pl-6 pr-2 py-2 text-[var(--white-color)] rounded-[100px] text-[4.5vw] lg:text-[1.1vw] font-[600] transition-transform ease-in-out hover:bg-stone-700 hover:scale-[1.015]'>Learn More <RightArrow  className='text-[8vw] lg:text-[2.0vw] p-2 ml-4 rounded-[50px] bg-stone-500' /></button></Link>
            </div>
