  ...
  return (
    ...
    '>
        <div className=' lg:w-[40%] lg:px-3'> 
            ...
            <h4 className='text-slate-50 mt-2 text-[3.5vw] lg:text-[1.05vw] tracking-[0.5px]'>Labour Master Solution Company is dedicated to HR excellence, delivering top-tier staff for our clients. We swiftly attract skilled candidates to meet your business needs, offering experienced and reliable temporary employees.</h4>
        </div>
        ...
        <div className=' lg:w-[28%] lg:px-4 lg:mr-[1%] flex flex-col'> 
            ...
            <h4 className='text-slate-50 mt-2 text-[3.5vw] lg:text-[1.1vw] tracking-[0.5px]'>Let us know how we can assist you, and we’ll respond at our earliest convenience.</h4>
            <div className='flex flex-col lg:flex-row w-full lg:mt-3' >
                ...
                <h4 className='text-[3.8vw] lg:text-[1.3vw] text-[var(--golden-color)] my-1 lg:mx-4 italic font-[600]'>OR</h4>
        ...
        <div className=' lg:w-[22%] lg:px-4 flex flex-col'> 
            ...
            <Link to={'tel:+16475090006'}  className='footer-contact-links mt-[1vh]'><CallUs className='text-[var(--golden-color)] mr-2 text-[4vw] lg:text-[1.4vw]'/> (647) 509 0006</Link>
            <Link to={'mailto:info@labourmaster.ca'}  className='footer-contact-links mt-[1vh]'><MailUs className='text-[var(--golden-color)] mr-2 text-[4vw] lg:text-[1.4vw]'/> info@labourmaster.ca</Link>
        ...
        <div className=' lg:w-[20%] lg:px-0'> 
            <h2 className='footer-heading text-[5.5vw] lg:text-[1.6vw]'>Follow Us</h2>
